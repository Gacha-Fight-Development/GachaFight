...
public class Prefix {
    ...
    public static String getGoldPrefix() {return "<!i><#E0AC23>💵 <gray>Gold Multiplier: <#E0AC23>";}
    public static String getExpPrefix() {return "<!i><#69E03E>✨ <gray>Exp Multiplier: <#69E03E>";}
