...
public class Calculations {
    ...
    public static double overseerHPCost(double hp) { return (0 + Math.pow(hp*0.6, 1+0.95))/2; }
    public static double overseerDamageCost(double dmg) { return (0 + Math.pow(dmg*3.5, 1+1.1))/2; }
