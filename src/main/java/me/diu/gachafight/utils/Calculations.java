...
public class Calculations {
    ...
    public static double overseerCritChanceCost(double critChance) { return 10 + (critChance*3 * 1.05); }
    public static double overseerCritDmgCost(double critDmg) { return 10 + (critDmg*3 * 0.05); }
    public static double overseerSpeedCost(double speed) { return 100 + Math.pow(speed*2.5, 1+2.5); }
